...
test('INVALID_LOGIN_ID', { tag: ["@get_job_list"] }, async ({ page }) => {
    ...
    const r = await page.evaluate(() => {
        ...
        const body = { "orgId": "WORKSPACE3-SVGW1OPZ7D", "appId": "96477173442322192121037", "clientId": "WORKSPACE3-SVGW1OPZ7D", "projectId": "96477173442322192121037", "loginId": "INVALID_LOGIN_ID", "jobId": "", "apiData": "" };
