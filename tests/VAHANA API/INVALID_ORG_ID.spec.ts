...
test('INVALID_ORG_ID', { tag: ["@get_job_list"] }, async ({ page }) => {
    ...
    const r = await page.evaluate(() => {
        ...
        const body = { "orgId": "INVALID_ORG_ID", "appId": "96477173442322192121037", "clientId": "WORKSPACE3-SVGW1OPZ7D", "projectId": "96477173442322192121037", "loginId": "praddumn.singh@decimal.co.in", "jobId": "", "apiData": "" };
