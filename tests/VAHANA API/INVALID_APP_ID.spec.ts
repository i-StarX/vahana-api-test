...
test('INVALID_APP_ID', { tag: ["@regression"] }, async ({ page }) => {
    ...
    const r = await page.evaluate(() => {
        ...
        const body = { "orgId": "WORKSPACE3-SVGW1OPZ7D", "appId": "INVALID_APP_ID", "clientId": "WORKSPACE3-SVGW1OPZ7D", "projectId": "96477173442322192121037", "loginId": "praddumn.singh@decimal.co.in", "jobId": "", "apiData": "" };
